...
namespace adc {
    ...
    */
    ...
    private:
        ...
        StaticSemaphore_t data_mutex_buffer;
        ...
        float calculate_average(const float* samples, uint32_t count);
        ...
        StackType_t processing_task_stack[PROC_TASK_STACK_SIZE];
        StaticTask_t processing_task_buffer;
    };
