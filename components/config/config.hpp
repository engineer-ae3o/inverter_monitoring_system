...
namespace config {
    ...
    constexpr inline gpio_num_t LED_PIN                              = GPIO_NUM_13;
    ...
    constexpr inline const char DATA_FILE_NAME[23]                   = "/storage/file_data.log";
    constexpr inline const char META_DATA_FILE_NAME[28]              = "/storage/file_meta_data.log";
